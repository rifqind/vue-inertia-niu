...
<template>
    ...
    <GeneralLayout>
        ...
        <table class="table table-sorted table-hover table-bordered table-search" ref="tabelRowGroup" id="tabel-kelompok-Baris">
            <thead>
                <tr class="bg-info-fordone">
                    <th class="first-column tabel-width-10" @click="clickSortProperties(rowGroup, 'number')">No.</th>
                    <th class="text-center tabel-width-70" @click="clickSortProperties(rowGroup, 'label')">Nama Kelompok Baris
                    </th>
        ...
        <Teleport to="body">
            <ModalBs :ModalStatus="createModalStatus" @close="createModalStatus = false" :title="'Tambah Kelompok Baris Baru'">
                <template #modalBody>
                    <form>
        ...
        <Teleport to="body">
            <ModalBs :ModalStatus="deleteModalStatus" @close="deleteModalStatus = false" :title="'Hapus Kelompok Baris'">
                <template v-slot:modalBody>
                    <label>Apakah Anda yakin akan menghapus Kelompok Baris ini? (Baris yang di dalamnya maka akan ikut terhapus)</label>
                </template>
