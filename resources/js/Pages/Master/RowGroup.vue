  ...
  <GeneralLayout>
    <div class="container-fluid">
      <div class="mb-2 d-flex flex-wrap align-items-center">
        <div class="h4 mb-2 mb-md-0 flex-grow-1">Daftar Kelompok Baris</div>
        ...
        <a @click="createModalStatus = true" class="btn mb-2 mb-md-0 bg-info-fordone"
          ><font-awesome-icon icon="fa-solid fa-plus" /> Tambah Kelompok Baris Baru</a
        >
      </div>
    </div>
    <FlashMessage
    ...
    >
      <thead>
        <tr class="bg-info-fordone">
          ...
          <th class="text-center th-order tabel-width-70" @click="clickToOrder('label')">
            Nama Kelompok Baris
          </th>
      ...
      >
        ...
        <template #modalFunction>
          <button
            ...
            @click.prevent="GoDownload('tabel-kelompok-Baris', downloadTitle)"
          >
            Simpan
          </button>
        </template>
    ...
    <Teleport to="body">
      ...
      >
        <template v-slot:modalBody>
          <label
            >Apakah Anda yakin akan menghapus Kelompok Baris ini? (Baris yang di dalamnya
