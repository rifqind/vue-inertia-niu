  ...
  <GeneralLayout>
    <div class="container-fluid">
      <div class="mb-2 d-flex flex-wrap align-items-center">
        <div class="h4 mb-2 mb-md-0 flex-grow-1">Daftar Kolom</div>
        ...
        <a @click="createModalStatus = true" class="btn mb-2 mb-md-0 bg-info-fordone"
          ><font-awesome-icon icon="fa-solid fa-plus" /> Tambah Kolom Baru</a
        >
      </div>
    </div>
    <FlashMessage
    ...
    >
      <thead>
        ...
        <tr class="">
          ...
          <td class="search-header">
            <input
              v-model.trim="searchColumnGroup"
              type="text"
              class="search-input form-control"
            />
          </td>
