  ...
  <GeneralLayout>
    <div class="container-fluid">
      <div class="mb-2 d-flex flex-wrap align-items-center">
        <div class="h4 mb-2 mb-md-0 flex-grow-1">Daftar Kelompok Kolom</div>
        ...
        <a @click="createModalStatus = true" class="btn mb-2 mb-md-0 bg-info-fordone"
          ><font-awesome-icon icon="fa-solid fa-plus" /> Tambah Kelompok Kolom Baru</a
        >
      </div>
    </div>
    <FlashMessage
    ...
    <div class="table-responsive-mobile">
      ...
      >
        ...
        <tbody>
          <tr
            v-for="columnG in paginatedData"
            :key="columnG.id"
            v-if="columnGroup.length > 0"
          >
      ...
      >
        ...
        <template #modalFunction>
          <button
            ...
            @click.prevent="GoDownload('tabel-kelompok-kolom', downloadTitle)"
          >
            Simpan
          </button>
        </template>
      ...
      <ModalBs
        ...
        @close="
          () => {
            ...
            modalTitle = 'Tambah Kelompok Kolom Baru';
            form.reset();
          }
        "
        :title="modalTitle"
    ...
    <Teleport to="body">
      ...
      >
        <template v-slot:modalBody>
          <label
            >Apakah Anda yakin akan menghapus Kelompok Kolom ini? (Kolom yang di dalamnya
            maka akan ikut terhapus)</label
          >
        </template>
