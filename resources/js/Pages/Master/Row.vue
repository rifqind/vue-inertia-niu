...
const downloadTemplate = () => {
  window.location.href = "/download-template/rows-template";
};
const downloadRoute = () => {
  try {
    const response =
      route("export-rowIndex") +
      "?" +
      new URLSearchParams({
        label: searchLabel.value,
        rowGroupsLabel: searchRowGroup.value,
  ...
  <GeneralLayout>
    <div class="container-fluid">
      <div class="mb-2 d-flex flex-wrap align-items-center">
        <div class="h4 mb-2 mb-md-0 flex-grow-1">Daftar Baris</div>
        <button class="btn mb-2 mb-md-0 bg-info mr-1" @click="uploadModal = !uploadModal">
        ...
        <a @click="createModalStatus = true" class="btn mb-2 mb-md-0 bg-info-fordone"
          ><font-awesome-icon icon="fa-solid fa-plus" /> Tambah Baris Baru</a
        >
      </div>
    </div>
    <FlashMessage
    ...
    >
      <thead>
        <tr class="bg-info-fordone">
          ...
          <th class="text-center th-order tabel-width-30" @click="clickToOrder('label')">
            Nama Baris
          </th>
          <th
            class="text-center th-order tabel-width-30"
            @click="clickToOrder('rowGroupsLabel')"
          >
            Nama Kelompok Baris
          </th>
                ...
                <div class="mb-3">
                  ...
                  <div class="row">
                    <input
                      ...
                      type="text"
                      class="ml-2 form-control col mr-1"
                      id="label"
                      placeholder="Isi Nama Baris"
                    />
                    <button
                      type="button"
                      class="btn btn-sm bg-success-fordone col-2 mr-2"
                      @click.prevent="addListInput"
                    >
                      Tambah
                    </button>
                  </div>
      ...
      >
        ...
        <template #modalFunction>
          <button
            type="button"
            class="btn btn-sm bg-success-fordone"
            @click.prevent="GoDownload('tabel-Baris', downloadTitle)"
          >
            Simpan
          </button>
        </template>
