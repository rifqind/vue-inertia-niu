  ...
  <GeneralLayout>
    <div class="container-fluid">
      <div class="mb-2 d-flex flex-wrap align-items-center">
        <div class="h4 mb-2 mb-md-0 flex-grow-1">Daftar Subjek</div>
        <button
        ...
        <a @click="createModalStatus = true" class="btn mb-2 mb-md-0 bg-info-fordone"
          ><font-awesome-icon icon="fa-solid fa-plus" /> Tambah Subjek Baru</a
        >
      </div>
    </div>
    <FlashMessage
      ...
      >
        <thead>
          <tr class="bg-info-fordone">
            <th
              class="first-column tabel-width-10"
              @click="clickSortProperties(subjects, 'number')"
            >
              No.
            </th>
            <th
              class="text-center tabel-width-70"
              @click="clickSortProperties(subjects, 'label')"
            >
              Nama Subjek
            </th>
      ...
      >
        ...
        <template #modalFunction>
          <button
            ...
            @click.prevent="GoDownload('tabel-subjek', downloadTitle)"
          >
            Simpan
          </button>
        </template>
