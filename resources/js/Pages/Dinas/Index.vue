  ...
  <GeneralLayout>
    <div class="container-fluid">
      <div class="mb-2 d-flex flex-wrap align-items-center">
        <div class="h4 flex-grow-1 mb-2 mb-md-0">Daftar Produsen Data</div>
        <button
        ...
        <Link :href="route('dinas.create')" class="btn mb-2 mb-md-0 bg-info-fordone"
          ><font-awesome-icon icon="fa-solid fa-plus" /> Tambah Produsen Data Baru</Link
        >
      </div>
      <FlashMessage
        ...
        <table class="table table-hover table-bordered" ref="tabelDinas" id="tabel-dinas">
          <thead>
            <tr>
              ...
              <th
                class="text-center th-order tabel-width-50"
                @click="clickToOrder('nama')"
              >
                Nama Produsen Data
              </th>
              <th class="text-center th-order" @click="clickToOrder('mw.label')">
                Wilayah Kerja
              </th>
      ...
      >
        ...
        <template #modalFunction>
          <button
            ...
            @click.prevent="GoDownload('tabel-dinas', downloadTitle)"
          >
            Simpan
          </button>
        </template>
        ...
        <template v-slot:modalBody>
          <form id="DinasForm" class="form-horizontal mb-3">
            <div class="form-group">
              ...
              />
              <div id="error-nama" v-if="form.errors.nama" class="text-danger">
                {{ form.errors.nama }}
              </div>
