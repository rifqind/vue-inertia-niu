...
const kabsDrop = ref({
  value: null,
  options:
    page.props.auth.user.dinas.wilayah_fullcode == "7100000000" ? kabs.slice(1) : kabs,
});
...
<template>
  ...
  <GeneralLayout>
    <div class="container-fluid">
      <div class="h4">PRODUSEN DATA</div>
      <div class="card">
        <div class="card-body">
      ...
      <Link :href="route('dinas.index')" class="btn btn-light border"
