  ...
  <GeneralLayout>
      ...
      >
        <thead>
          <tr class="bg-info-fordone">
            <th
              class="first-column text-center align-middle th-order"
              @click="clickSortProperties(tables, 'number')"
            >
              No.
            </th>
            <th
              class="text-center align-middle tabel-width-20 th-order"
              @click="clickToOrder('tabels.label')"
            >
              Nama Tabel
            </th>
            <th
              class="text-center th-order align-middle tabel-width-20"
              @click="clickToOrder('dinas.nama')"
            >
              Produsen Data
            </th>
            <th class="text-center align-middle tabel-width-20">Daftar Kolom</th>
            <th class="text-center align-middle">Daftar Baris</th>
            <th
              class="text-center align-middle th-order"
              @click="clickToOrder('statustables.tahun')"
            >
              Tahun
            </th>
            <th
              class="text-center align-middle th-order"
              @click="clickToOrder('status_desc.label')"
            >
              Status Pengisian
            </th>
            <th
            ...
            <th class="text-center align-middle tabel-width-5">Cek/Hapus</th>
          </tr>
          <tr class="">
        ...
        <tbody>
          ...
          >
            ...
            <td class="text-center align-middle deleted">
              <Link
                :href="route('tabel.entri', { id: table.id_statustables })"
                class="edit-pen mx-1"
              >
                <font-awesome-icon icon="fa-solid fa-pencil" title="Cek/Edit" />
              </Link>
              <a @click.prevent="toggleModalOrders(table.id_statustables)"
                ><font-awesome-icon
                  icon="fa-solid fa-sort"
                  class="edit-pen mx-1"
                  title="Edit Urutan Kolom/Baris"
              /></a>
              <a
                v-if="
                  currentRoute == 'tabel.index' &&
                  (page.props.auth.user.role == 'admin' ||
                    page.props.auth.user.role == 'kominfo')
                "
                @click.prevent="
                  () => {
              ...
              <a
                @click.prevent="toggleModalForceDelete(table.id_statustables)"
                v-if="
                  page.props.route == 'tabel.deletedList' &&
                  page.props.auth.user.role == 'admin'
                "
                class="edit-pen mx-1"
              >
    ...
    <Teleport to="body">
      ...
      >
        ...
        <template #modalFunction>
          <button
            ...
            @click.prevent="GoDownload('tabel-kolom', downloadTitle)"
          >
            Simpan
          </button>
        </template>
      ...
      >
        <template v-slot:modalBody>
          <label
            >Apakah Anda yakin akan menghapus Tabel tahun ini? Tabel ini tidak akan
            kembali lagi setelah Anda menghapusnya</label
          >
        </template>
        <template v-slot:modalFunction>
          <button
