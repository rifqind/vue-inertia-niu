...
<template>
  ...
  <GeneralLayout>
    <div>
      <div class="h4">Edit Profil : {{ user.name }}</div>
      <FlashMessage
      ...
      <form @submit.prevent="submit">
          ...
          <div class="card-body">
            ...
            <div class="row mb-3" v-if="page.props.auth.user.role == 'admin'">
              ...
              <div class="col-7 d-flex flex-column">
                ...
                <div
                  class="text-danger text-left"
                  v-if="form.errors.id_dinas"
                  id="error-id_dinas"
                >
                  {{ form.errors.id_dinas }}
                </div>
              </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="text-right">
              <button class="btn btn-sm bg-success-fordone editButton mr-2">
                <font-awesome-icon icon="fa-solid fa-check mr-2" /> Simpan
              </button>
              <div
                id="changePassword"
              ...
              >
                <font-awesome-icon icon="fa-solid fa-key mr-2" /> Ganti Password
              </div>
            </div>
          </div>
        </div>
        <div class="card" v-if="changePassword">
          <div class="card-body">
            ...
            <div class="row mb-3">
              <div class="col-5 d-flex align-items-center">
                <label class="mb-0" for="password_confirmation"
            ...
            <div class="text-right">
              <button id="addUsers" class="btn btn-sm btn-warning">
                <font-awesome-icon icon="fa-solid fa-save" /> Simpan Password Baru
              </button>
            </div>
          </div>
        </div>
      </form>
      <a @click="goBack" class="btn btn-light border"
        ><font-awesome-icon icon="fas fa-chevron-left" /> Kembali
      </a>
    </div>
  </GeneralLayout>
</template>
